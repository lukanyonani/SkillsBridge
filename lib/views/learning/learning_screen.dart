...
class _LearningHubScreenState extends ConsumerState<LearningHubScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // Check if "All" category is selected (index 0)
    final isAllCategorySelected = viewModel.selectedCategoryIndex == 0;
        ...
        children: [
          ...
          Expanded(
            child: RefreshIndicator(
              onRefresh: () => isAllCategorySelected
                  ? viewModel.refreshData()
                  : Future.value(),
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    // Only show featured course when "All" category is selected
                    ...
                    if (viewModel.hasMorePages) _buildLoadMoreButton(viewModel),
