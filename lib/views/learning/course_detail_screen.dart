...
//     return Consumer<LearningHubViewModel>(
...
//   Widget _buildCourseInfo(LearningHubViewModel viewModel) {
//     final course = viewModel.featuredCourse;
//     if (course == null) {
...
//               children: [
//                 _buildStat('⭐', 'Free'),
//                 _buildStat('👥', '${course.level}'),
//                 _buildStat('⏱️', '30 Videos'),
//               ],
//             ),
//           ),
...
//   Widget _buildSyllabus(LearningHubViewModel viewModel) {
//     final sectionTitles = [
...
//             return _buildSyllabusItem(title, index, viewModel);
//           }),
//         ],
//       ),
//     );
...
//     LearningHubViewModel viewModel,
//   ) {
//     final isExpanded = viewModel.expandedSections[index];
//     return Container(
...
//               child: Text(
//                 'Detailed content for this section goes here. This is where you would find lectures, readings, and assignments.',
...
//   Widget _buildRelatedCourses(LearningHubViewModel viewModel) {
