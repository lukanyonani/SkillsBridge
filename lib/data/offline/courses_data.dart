  ...
  static List<Course> getSampleCourses() {
    return [
      Course(
        ...
        lessons: [
          Lesson(
            ...
            description: 'Get started with Flutter development environment',
            videoUrl: 'https://example.com/videos/flutter-intro.mp4',
            thumbnailUrl: 'https://example.com/thumbs/flutter-intro.jpg',
            ...
            resources: [
              ...
              'https://dartlang.org/guides',
            ],
          ),
          Lesson(
            id: 'lesson_1_2',
            title: 'Setting Up Your Development Environment',
            description: 'Install Flutter SDK and configure your IDE',
            videoUrl: 'https://example.com/videos/flutter-setup.mp4',
            thumbnailUrl: 'https://example.com/thumbs/flutter-setup.jpg',
            duration: Duration(minutes: 22, seconds: 15),
            orderIndex: 2,
            type: LessonType.video,
            resources: ['https://flutter.dev/docs/get-started/install'],
          ),
          Lesson(
            id: 'lesson_1_3',
            title: 'Your First Flutter App',
            description: 'Build your first Hello World app in Flutter',
            videoUrl: 'https://example.com/videos/first-app.mp4',
            thumbnailUrl: 'https://example.com/thumbs/first-app.jpg',
          ...
          Lesson(
            ...
            description: 'Deep dive into Flutter widgets and widget tree',
            videoUrl: 'https://example.com/videos/widgets.mp4',
            thumbnailUrl: 'https://example.com/thumbs/widgets.jpg',
      ...
      Course(
        ...
        instructor: 'SkillsBridge',
        thumbnailUrl: 'https://example.com/react-native-course.jpg',
        ...
        pricing: CoursePricing(
          ...
          discountExpiry: DateTime.now().add(Duration(days: 7)),
        ),
        totalDuration: Duration(hours: 28, minutes: 30),
        lessons: [
          Lesson(
            id: 'lesson_2_1',
            title: 'React Native Fundamentals',
            description: 'Understanding React Native architecture',
            videoUrl: 'https://example.com/videos/rn-fundamentals.mp4',
            thumbnailUrl: 'https://example.com/thumbs/rn-fundamentals.jpg',
          ...
          Lesson(
            ...
            thumbnailUrl: 'https://example.com/thumbs/rn-navigation.jpg',
          ...
          Lesson(
            ...
            videoUrl: 'https://example.com/videos/redux.mp4',
            thumbnailUrl: 'https://example.com/thumbs/redux.jpg',
            duration: Duration(minutes: 32, seconds: 15),
            orderIndex: 3,
            type: LessonType.video,
          ),
        ],
      ...
      Course(
        ...
        instructor: 'SkillsBridge',
        thumbnailUrl: 'https://example.com/design-course.jpg',
        level: CourseLevel.beginner,
        category: CourseCategory.design,
        rating: 4.7,
        reviewCount: 1420,
        pricing: CoursePricing(type: PricingType.free),
        totalDuration: Duration(hours: 24, minutes: 15),
        lessons: [
          Lesson(
            id: 'lesson_3_1',
            ...
            thumbnailUrl: 'https://example.com/thumbs/design-thinking.jpg',
          ...
          Lesson(
            ...
            description: 'Master color palettes and typography choices',
            videoUrl: 'https://example.com/videos/color-typography.mp4',
            thumbnailUrl: 'https://example.com/thumbs/color-typography.jpg',
            duration: Duration(minutes: 28, seconds: 45),
            orderIndex: 2,
            type: LessonType.video,
          ),
          Lesson(
            ...
            thumbnailUrl: 'https://example.com/thumbs/wireframing.jpg',
            duration: Duration(minutes: 35, seconds: 20),
            orderIndex: 3,
            type: LessonType.video,
          ),
      ...
      Course(
        ...
        description:
            'Comprehensive data science course using Python and modern tools',
        instructor: 'SkillsBridge',
        thumbnailUrl: 'https://example.com/data-science-course.jpg',
        level: CourseLevel.intermediate,
        ...
        totalDuration: Duration(hours: 45, minutes: 30),
        lessons: [
          Lesson(
            id: 'lesson_4_1',
            ...
            thumbnailUrl: 'https://example.com/thumbs/data-science-intro.jpg',
            duration: Duration(minutes: 16, seconds: 15),
            orderIndex: 1,
            isPreview: true,
            type: LessonType.video,
          ),
          Lesson(
            ...
            thumbnailUrl: 'https://example.com/thumbs/python-data-science.jpg',
          ...
          Lesson(
            ...
            thumbnailUrl: 'https://example.com/thumbs/data-visualization.jpg',
            duration: Duration(minutes: 38, seconds: 45),
            orderIndex: 3,
            type: LessonType.video,
          ),
          Lesson(
            ...
            videoUrl: 'https://example.com/videos/ml-fundamentals.mp4',
            thumbnailUrl: 'https://example.com/thumbs/ml-fundamentals.jpg',
